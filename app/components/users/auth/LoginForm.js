    ...
    return (
        <View className="justify-center items-center h-full px-4 gap-4">
            <View className="gap-4 w-full items-center">
                <Title>Login:</Title>
                <TextInput value={email} onChangeText={setEmail} placeholder="Ingrese el Email.." className="border-2 border-black rounded-lg h-10 pl-2 shdaow-black shadow-sm text-black w-full" />
                <TextInput secureTextEntry={true} value={password} onChangeText={setPassword} placeholder="Ingrese la Contraseña.." className="border-2 border-black rounded-lg h-10 pl-2 shdaow-black shadow-sm text-black w-full" />
            </View>
            <View className="flex-row gap-2 w-full justify-center items-center px-1">
                <Link href="/" asChild className="w-[50%]">
